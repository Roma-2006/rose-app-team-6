...
export default function Stepper({ currentStep }: StepperProps) {
  ...
  return (
    <div className="w-full flex items-center justify-center mb-8" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="flex items-center w-full relative">
        {/*------------------ الخطوط --------------------- */}
        <div className="absolute top-1/2 left-[20px] right-[20px] border-t border-bg-primary-faint -translate-y-1/2" />
        ...
        <div className="flex justify-between w-full relative z-10">
          {steps.map((step) => {
            ...
            return (
              <div
                key={step}
                className="relative flex items-center justify-center px-3 transition-colors duration-300"
              >
                {/*--------------------Circular step -----------------------*/}
                <div
